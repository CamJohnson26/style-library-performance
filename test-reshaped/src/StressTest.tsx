...
const StressTest: React.FC<StressTestProps> = ({ componentCount, onMetricsUpdate }) => {
  ...
  const generateItems = useCallback(() => {
    ...
    for (let i = 0; i < componentCount; i++) {
      newItems.push({
        id: i,
        title: `Reshaped Item ${i + 1}`,
        description: `This is a Reshaped test item with ID ${i + 1} for comprehensive performance testing and evaluation`,
      ...
      <div className="stress-test-container">
        <div className="stress-test-header">
          <div className="stress-test-header-content">
            <div>
              <h2>Reshaped Performance Stress Test</h2>
              <p>Testing Reshaped component rendering and interaction performance</p>
            </div>
          ...
          {isRendering && (
            <div className="stress-test-progress">
              <p>Rendering {componentCount} Reshaped components...</p>
